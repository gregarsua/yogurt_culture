...
<body>
  ...
  <div class="check_choices">
    ...
    <div class="choice">
      <section id="nano" class="check_choices__week-chosen none">
        <div class="week-one">
      ...
      <section id="micro" class="check_choices__week-chosen none choose_food_slider">
        <div class="week-one">
          <h2 class="check_choices__week-chosen__title">Week One</h2>
          <div class="check_choices__week-chosen__date-pick">
            <p class="date-pick_day">Mon</p>
        ...
        <div class="week-two">
          <h2 class="check_choices__week-chosen__title">Week Two</h2>
          <div class="check_choices__week-chosen__date-pick">
            <p class="date-pick_day">Mon</p>
            <p class="pick-food "></p>
          </div>
      ...
      <section id="mega" class="check_choices__week-chosen none choose_food_slider">
        <div class="week-one">
          <h2 class="check_choices__week-chosen__title">Week One</h2>
          <div class="check_choices__week-chosen__date-pick">
            <p class="date-pick_day">Mon</p>
        ...
        <div class="week-three">
          <h2 class="check_choices__week-chosen__title">Week Three</h2>
          <div class="check_choices__week-chosen__date-pick">
            <p class="date-pick_day">Mon</p>
            <p class="pick-food "></p>
          </div>
        ...
        <div class="week-four">
          <h2 class="check_choices__week-chosen__title">Week Four</h2>
          <div class="check_choices__week-chosen__date-pick">
            <p class="date-pick_day">Mon</p>
            <p class="pick-food "></p>
          </div>
    ...
    <div class="back-container">
      <div class="container_width_50"></div>
      <a href="http://wordpress.test/step4">
        <p class="back">BACK</p>
      </a>
    </div>
